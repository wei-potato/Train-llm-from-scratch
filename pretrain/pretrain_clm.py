    ...
    def __post_init__(self):
        ...
        if self.dataset_name is None and self.train_files is None and self.validation_files is None:
            ...
            if self.validation_files is not None:
                ...
                assert extension in ["csv", "json", "txt",
                                     "jsonl"], "`validation_file` should be a csv, a json or a txt file."
...
def main():
    ...
    print("Running tokenizer on dataset 开始")
    ...
    print("Running tokenizer on dataset 结束")
    ...
    if training_args.do_train:
        ...
        print("if data_args.max_train_samples is not None else len(train_dataset)")
        metrics["train_samples"] = min(max_train_samples, len(train_dataset))
        trainer.log_metrics("train", metrics)
        trainer.save_metrics("train", metrics)
        print("trainer.save_metrics")
        trainer.save_state()
